...
# U-NET architecture
architecture = 'vgg16' # efficient net ('resnet34' 'resnet50' 'resnet101' 'resnet152' or 'efficientnetb0' 'efficientnetb1')
...
model = sm.Unet(architecture, encoder_weights=None)
